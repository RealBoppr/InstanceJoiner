...
namespace RubyButtonAPI
{
    ...
    public static class QMButtonAPI
    {
        ...
        public static string identifier = "InstanceJoiner";
    ...
    {
        //Stolen from Arion
        public static void ChangeButtonSize(GameObject Button, float xSize, float ySize)
        {
            Button.GetComponent<RectTransform>().sizeDelta = new Vector2(xSize, ySize);
        }

        //Added by me uwu
        public static void MoveButton(GameObject Button, float xPos, float yPos)
        {
            Button.GetComponent<RectTransform>().localPosition = new Vector3(xPos, yPos);
        }
    }
